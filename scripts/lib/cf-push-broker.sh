...
[[ -n "${AWS_BUDGET_ALERT_EMAIL:-}" ]] && add_env "AWS_BUDGET_ALERT_EMAIL" "${AWS_BUDGET_ALERT_EMAIL}"
[[ -n "${GOOGLE_CREDENTIALS:-}"    ]] && add_env "GOOGLE_CREDENTIALS"      "${GOOGLE_CREDENTIALS}"
[[ -n "${GOOGLE_PROJECT:-}"        ]] && add_env "GOOGLE_PROJECT"           "${GOOGLE_PROJECT}"
[[ -n "${GCP_BUDGET_ALERT_EMAIL:-}" ]] && add_env "GCP_BUDGET_ALERT_EMAIL" "${GCP_BUDGET_ALERT_EMAIL}"
[[ -n "${AZURE_BUDGET_CONTACT_EMAIL:-}" ]] && add_env "AZURE_BUDGET_CONTACT_EMAIL" "${AZURE_BUDGET_CONTACT_EMAIL}"
[[ -n "${AZURE_BUDGET_WEBHOOK_URL:-}"  ]] && add_env "AZURE_BUDGET_WEBHOOK_URL"  "${AZURE_BUDGET_WEBHOOK_URL}"
