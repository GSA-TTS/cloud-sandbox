          ...
          <div className="grid-row grid-gap">
            <div className="usa-layout-docs__main desktop:grid-col-9 usa-prose">
              ...
              {results.length > 0 ? (
                ...
                <h4 className="title">No results found for search term: {query}</h4>
              )}

              {affiliate === "federalist-uswds-example" && (
                <div className="usa-alert usa-alert--info">
                  <div className="usa-alert__body">
                    This is an example. You will need to configure your site with search.gov to see
                    the correct search results. To do this:
                    <ol>
                      <li>
                        Create an account with Search.gov at{" "}
                        <a href="https://search.usa.gov/signup">https://search.usa.gov/signup</a>
                      </li>
                      <li>Go to the "Activate" section and get "API Access Key"</li>
                      <li>
                        Open <code>gatsby-config.js</code> and look for <code>searchgov</code>{" "}
                        fields
                      </li>
                      <li>
                        Add your <code>affiliate</code> and <code>access_key</code>
                      </li>
                      <li>
                        Your results will not show up immediately. Make sure you follow{" "}
